...
if [[ "${target_platform}" == "osx-arm64" ]]; then
    ...
    export CMAKE_ARGS="${CMAKE_ARGS} -D CPP_CXX_ABI_RUN_RESULT_VAR=0 -D CPP_CXX_ABI=0 -D PY_CXX_ABI_RUN_RESULT_VAR=0 -D PY_CXX_ABI=0 -D TENSORFLOW_VERSION_RUN_RESULT_VAR=0 -D TENSORFLOW_VERSION=2.10 "
fi
